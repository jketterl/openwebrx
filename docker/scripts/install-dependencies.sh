...
JS8CALL_VERSION=2.2.0-ga
JS8CALL_DIR=js8call-${JS8CALL_VERSION} # root folder name of zip is js8call-2.2.0-ga
JS8CALL_ZIP=${JS8CALL_DIR}.zip
# wget https://github.com/js8call/js8call/archive/refs/tags/v2.2.0-ga.zip -O js8call-2.2.0-ga.zip
wget https://github.com/js8call/js8call/archive/refs/tags/v${JS8CALL_VERSION}.zip -O ${JS8CALL_ZIP}
unzip ${JS8CALL_ZIP}
